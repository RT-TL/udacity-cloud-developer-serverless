...
const jwksUrl = 'https://dev-ktkrf397.eu.auth0.com/.well-known/jwks.json'
...
async function verifyToken(authHeader: string): Promise<JwtPayload> {
  ...
  return verify(token, key.x5c, { algorithms: ['RS256'] }) as JwtPayload
}
...
// Get keys and extract the applicable key by provided kid
...
// Create PEM formattaed certificate
